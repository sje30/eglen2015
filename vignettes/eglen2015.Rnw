...
\textit{Neuroinformatics} has a similar approach to listing whether
code is available \citep{Ascoli2014-dk}.  Outside of the sciences, the
journal \textit{Quarterly Journal of Political Science} since 2005 has
required all empirical papers to be reproducible.  See
