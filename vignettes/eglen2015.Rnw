...
\item define K and L for univariate and bivariate case.
...
utility in other regions of the nervous system, and have indeed
recently been applied to striatum and spinal cord
\citep{Gangarossa2013-cc,Prodanov2007-fe}.  Finally, although we have
used these techniques here to demonstrate the spatial organisation of
anatomical features, they can also be used for physiological features,
such as the arrangement of centres of receptive fields \citep{Hore2012-ac}.
