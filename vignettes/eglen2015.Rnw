...
TODO
\begin{itemize}
\item Finish figure 1 with abbrevs: five main classes of neuron.
...
TODO This paper is available as a reproducible research document, written
in the knitr framework \citep{Knitrxxx}
