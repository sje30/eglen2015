...
\citep{Diggle,Peng2011-75a}.  The journal \textit{Science} requires
authors to generated supporting online material including relevant
code and data.  As an example, \citet{Vogels2011-c8c} provides a
comprehensive supplement in the field of computational neuroscience.
Most recently, in 2014, Nature journals began to request computer code
relating to papers to be made available upon publication \citep{...}.
